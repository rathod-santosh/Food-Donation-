...
exports.acceptDonation = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, donationId, deliveryOption, deliveryFee, donation;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, donationId = _req$body.donationId, deliveryOption = _req$body.deliveryOption, deliveryFee = _req$body.deliveryFee;
          _context.prev = 1;
          _context.next = 4;
...
exports.updateDonationStatus = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body2, donationId, deliveryMethod, deliveryCharge, pickupLocation, dropLocation, donation;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _req$body2 = req.body, donationId = _req$body2.donationId, deliveryMethod = _req$body2.deliveryMethod, deliveryCharge = _req$body2.deliveryCharge, pickupLocation = _req$body2.pickupLocation, dropLocation = _req$body2.dropLocation;
          _context2.next = 4;
          return Donation.findById(donationId);
        case 4:
