...
var Donation = require('../models/donation'); // Assuming Donation model exists
...
module.exports.viewDonations = function (req, res) {
...
exports.getPendingDonations = /*#__PURE__*/function () {
...
exports.updateDonationStatus = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, donationId, status, donation, acceptingUser, donor, notification, mailOptions;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _req$body = req.body, donationId = _req$body.donationId, status = _req$body.status; // ✅ Check if required parameters are provided
        ...
        case 9:
          ...
          acceptingUser = req.session.user; // ✅ Ensure user session exists
          // ✅ Add notification to donation
          donation.notifications.push({
            message: "Accepted by ".concat(acceptingUser.username),
            date: new Date()
          });
          _context2.prev = 14;
          _context2.next = 17;
        ...
        case 17:
          ...
          notification = new Notification({
            userId: donor._id,
            message: "Your ".concat(donation.foodname, " donation was accepted by ").concat(acceptingUser.username)
          });
          _context2.next = 22;
        ...
        case 27:
          ...
          console.error("❌ Email notification error:", _context2.t0);
        case 30:
          _context2.next = 32;
        ...
        case 35:
          ...
          console.error("❌ Update error:", _context2.t1);
          res.status(500).json({
            success: false,
            message: "Server Error: ".concat(_context2.t1.message)
          });
        case 39:
        case "end":
          return _context2.stop();
      }
    }, _callee2, null, [[0, 35], [14, 27]]);
  }));
...
exports.getAcceptedDonations = /*#__PURE__*/function () {
